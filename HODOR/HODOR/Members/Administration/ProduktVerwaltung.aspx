<%@ Page Title="" Language="C#" MasterPageFile="~/SubPageIntern.Master" AutoEventWireup="true"
    CodeBehind="ProduktVerwaltung.aspx.cs" Inherits="HODOR.Members.Administration.ProduktVerwaltung" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RadioButton ID="radioProduct" runat="server" AutoPostBack="true" GroupName="SearchType"
                Text="Product" OnCheckedChanged="MenuLink_Command" />
            &nbsp;
            ...
            <asp:MultiView ID="MultiView1" runat="server">
                ...
                <asp:View ID="CategorySearchView" runat="server">
                    Enter category:
