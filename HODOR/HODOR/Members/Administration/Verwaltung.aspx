...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="PreResultView" runat="server">
            <h2>
                <asp:Label ID="l_searchHeader" runat="server" Text="Gefundene Produkte: " />
            </h2>
            <p>
        ...
        <asp:View ID="ResultView" runat="server">
            <p>
                ...
                <asp:Label ID="l_ReleaseID" runat="server" Text="" Visible="false" />
                <asp:Label ID="l_ReleaseNummer" runat="server" Text="" Visible="false" />
                <br />
            </p>
                    ...
                    <tr class="itemTemplate">
                        ...
                        <td class="action">
                            <asp:LinkButton ID="lb_Lizenzen" runat="server" Text="Lizenzen"
                                CommandArgument='<%# Eval("NutzerNr") %>' OnCommand="lb_Lizenzen_Command" /><br />
                    ...
                    <tr class="selectedItemTemplate">
                        ...
                        <td class="action">
                            ...
                            <asp:LinkButton ID="lb_Details1" runat="server" Text="Bearbeiten"
                                CommandName="Edit" /><br />
                            <asp:LinkButton ID="lb_delete" runat="server" Text="Löschen"
                                CommandName="Delete" OnClientClick="return confirm('Sind Sie sicher, dass Sie dieses Release löschen wolle?');" />
                        </td>
                    </tr>
                </SelectedItemTemplate>
                <EditItemTemplate>
                    <tr class="editItemTemplate">
                        ...
                        <td>
                            <asp:Label ID="EditReleasenummer" runat="server" Text='<%# Bind("Releasenummer") %>' TextMode="SingleLine" MaxLength="255" />
                        </td>
                        <td>
                            <asp:Label ID="EditReleasedatum" runat="server" Text='<%# Bind("Releasedatum") %>' TextMode="SingleLine" MaxLength="255" />
                        </td>
                        <td>
            ...
            <asp:ListView ID="lv_subRelease" runat="server" DataKeyNames="ReleaseID"
                ...
                <ItemTemplate>
                    <tr class="itemTemplate">
                        ...
                        <td>
                            <asp:Label ID="l_test" runat="server" Text='<%# Eval("Releasenummer") %>' />
                        </td>
                        <td>
                            <%# Eval("Releasedatum", "{0:dd.MM.yy}") %>
                        </td>
            ...
            <asp:ListView ID="lv_Build" runat="server" DataKeyNames="ReleaseID"
                ...
                OnItemCanceling="lv_Build_ItemCanceling">
                <LayoutTemplate>
                    <table id="Table3" class="ExampleView" runat="server">
                        <tr id="Tr1" runat="server">
                            <td id="Td1" runat="server">
